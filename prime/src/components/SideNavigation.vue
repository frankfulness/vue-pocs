...
<template>
  <div class="card">
      <MegaMenu :model="items" class="p-4" style="border-radius: 0.5rem" orientation="vertical">
          <template #start>
            <p class="flex px-4 py-4 text-2xl text-primary-500 font-bold"> Left Mega Menu </p>
              <svg width="35" height="40" viewBox="0 0 35 40" fill="var(--p-primary-contrast-color)" xmlns="http://www.w3.org/2000/svg" class="h-8">
                  <path
